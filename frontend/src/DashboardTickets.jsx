...
import logoDGMM from "./imagenes/DGMM-Gobierno.png"; // <-- AGREGA ESTA LÍNEA (Ajusta el nombre del archivo si es diferente)
      ...
      <aside className="sb2">
        <div className="sb2__head">
          <div className="sb2__brand">
            {/* Ahora logoDGMM ya existe porque lo importamos arriba */}
