...
export default function DetalleCompra() {
  ...
  // === Usuario logueado para la bitácora ===
  ...
  const generarPDF = () => {
    ...
    const columnas = ["ID", "Proveedor", "Monto", "Fecha"];
  ...
  return (
    <div className="inventario-page">
      ...
      <div className="inventario-card" style={{ maxWidth: 1000 }}>
        ...
        {loading ? (
          <div className="loading">Cargando detalle de compra...</div>
        ) : (
...
<th></th>
            ...
            <tbody>
              ...
              {items.length === 0 && (
                <tr>
                  <td colSpan={5} className="no-data">No hay registros</td>
                </tr>
              )}
            </tbody>
