...
app.get('/api/sp-compras', verificarToken, SOLO_ALMACEN_O_ADMIN, autorizarPermiso("Compras", "consultar"), (req, res) => {
  const user = req.user;
...
app.post('/api/sp-compras', verificarToken, SOLO_ALMACEN_O_ADMIN, autorizarPermiso("Compras", "insertar"), (req, res) => {
...
app.get('/api/sp-detalle-compra', verificarToken, SOLO_ALMACEN_O_ADMIN, autorizarPermiso("Compras", "consultar"), (req, res) => {
  const user = req.user;
  const query = "CALL SP_MostrarDetalleCompra()";
...
app.post('/api/sp-detalle-compra', verificarToken, SOLO_ALMACEN_O_ADMIN, autorizarPermiso("Compras", "insertar"), (req, res) => {
...
app.post('/api/sp-registrar-entrada/:id_compra', verificarToken, SOLO_ALMACEN_O_ADMIN, autorizarPermiso("Compras", "insertar"), (req, res) => {
...
app.get('/api/sp-salidas', verificarToken, SOLO_ALMACEN_O_ADMIN, autorizarPermiso("Salidas", "consultar"), (req, res) => {
  const user = req.user;
...
app.post('/api/sp-salidas', verificarToken, SOLO_ALMACEN_O_ADMIN, autorizarPermiso("Salidas", "insertar"), (req, res) => {
...
app.get('/api/sp-detalle-salida', verificarToken, SOLO_ALMACEN_O_ADMIN, autorizarPermiso("Salidas", "consultar"), (req, res) => {
  const user = req.user;
...
app.post('/api/sp-detalle-salida', verificarToken, SOLO_ALMACEN_O_ADMIN, autorizarPermiso("Salidas", "insertar"), (req, res) => {
